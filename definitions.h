...
// Matrix addresses.
constexpr AddressT kFeaturesMatrixAddress = 0;
constexpr AddressT kFirstOutMatrixAddress = 1; // I switched the order of the two addresses to make default 0 as features input. What is the impact?
