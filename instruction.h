...
class Instruction {
 public:
  ...
  Instruction(Op op, AddressT in1, AddressT in2, AddressT in3, AddressT in4, AddressT out);
  Instruction(Op op, AddressT in1, AddressT in2, AddressT out, const FloatDataSetter& float_data_setter_0);
  Instruction(
      Op op, AddressT out,
  ...
  void RandomizeIn3(RandomGenerator* rand_gen);
  void RandomizeIn4(RandomGenerator* rand_gen);
  ...
  AddressT in3_;  // Second input address.
  AddressT in4_;  // Second input address.  
