...
Choice4T RandomGenerator::Choice4() {
  return static_cast<Choice4T>(absl::Uniform<IntegerT>(*bit_gen_, 0, 4));
}

Choice5T RandomGenerator::Choice5() {
  return static_cast<Choice5T>(absl::Uniform<IntegerT>(*bit_gen_, 0, 5));
}
