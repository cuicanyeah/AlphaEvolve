...
class Generator {
 public:
  ...
  // James: addressTer assign address for each string variable name read from input file
  AddressT AddressTer(const std::string variable_name);

  template<typename T>
  bool isNumber(T x);
  // James: build algo based on each of the three parts
  ...
  // James: build setup part of algo
  ...
  // James: build predict part of algo
  ...
  // James: build learn part of algo
  ...
  // James: build from txt main function
