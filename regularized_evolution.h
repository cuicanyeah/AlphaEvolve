...
class RegularizedEvolution {
 ...
 private:
  ...
  void MaybePrintProgress(std::vector<double>* strategy_ret, std::vector<double>* valid_strategy_ret, std::vector<IntegerT>* useful_list);
  ...
  std::vector<double> strategy_ret_;
